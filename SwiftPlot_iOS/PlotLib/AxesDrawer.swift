...
//        CGContextSetFillColorWithColor(context, UIColor(red: 0, green: 0, blue: 0, alpha: 0.9).CGColor)
        CGContextSetFillColorWithColor(context, UIColor(red: 1, green: 1, blue: 1, alpha: 0.95).CGColor)
        ...
        path.addLineToPoint(CGPoint(x: bounds.maxX, y: align(position.y + lineHalfWidth)))
        
        //draw y-axis
        path.moveToPoint(CGPoint(x: align(position.x + lineHalfWidth), y: align(bounds.minY + padding.y) ))
        path.addLineToPoint(CGPoint(x: align(position.x + lineHalfWidth), y: bounds.maxY))
        ...
        path.addLineToPoint(CGPoint(x: bounds.minX + padding.x, y: bounds.maxY - lineHalfWidth))

        
        path.moveToPoint(CGPoint(x: bounds.minX + padding.x, y: bounds.maxY - lineHalfWidth))
        path.addLineToPoint(CGPoint(x: bounds.maxX, y: bounds.maxY - lineHalfWidth))
        
        path.moveToPoint(CGPoint(x: bounds.maxX - lineHalfWidth, y: bounds.maxY - lineHalfWidth))
        path.addLineToPoint(CGPoint(x: bounds.maxX - lineHalfWidth, y: bounds.minY + padding.y))
        
        path.moveToPoint(CGPoint(x: bounds.minX + padding.x, y: bounds.minY + padding.y + lineHalfWidth))
        path.addLineToPoint(CGPoint(x: bounds.maxX, y: bounds.minY + padding.y + lineHalfWidth))
        ...
        for gridSpacing = align(bounds.minX + padding.x) ; gridSpacing < bounds.maxX ; gridSpacing += align(ppX) {
            ...
            path.addLineToPoint(CGPoint(x: align(gridSpacing), y: bounds.maxY))
        }
        
        for gridSpacing = align(posY) ; gridSpacing < bounds.maxY ; gridSpacing += align(ppY) {
            path.moveToPoint(CGPoint(x: bounds.minX + padding.x, y: align(gridSpacing)))
            path.addLineToPoint(CGPoint(x: bounds.maxX, y: align(gridSpacing)))
        }
        
        for gridSpacing = align(posY) ; gridSpacing > bounds.minY ; gridSpacing -= align(ppY) {
            path.moveToPoint(CGPoint(x: bounds.minX + padding.x, y: align(gridSpacing)))
            path.addLineToPoint(CGPoint(x: bounds.maxX, y: align(gridSpacing)))
        }
