...
class SRPlotSegment : NSObject {
    ...
    override func drawLayer(layer: CALayer, inContext ctx: CGContext) {
        ...
        for var c = 0; c < dataStorage.count; ++c
        {
            ...
            CGContextSetStrokeColorWithColor(ctx, UIColor.prismColor[c].CGColor);
...
//    override func layer(layer: CALayer, shouldInheritContentsScale newScale: CGFloat, fromWindow window: UIWindow) -> Bool {
//        return true
//    }
